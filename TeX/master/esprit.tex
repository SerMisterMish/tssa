...
сигнала, восстановленного методом HO-SSA с применением HOOI при
выборе различных
направлений усечения.
Метод применение HOSVD на шаге разложения даёт менее точные схожие результаты.
...
% В большинстве рассмотренных примеров HO-SSA оказался хуже,
% чем стандартный метод SSA в точности выделения сигнала.
...
% Также в коде использованы пакеты~\cite{rTensor-pack, tensr-pack,
% purrr-pack}.
