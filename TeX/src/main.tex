...
%    \FloatBarrier
    ...
    Чтобы продемонстрировать верность этих суждений, рассмотрим $\hat{\sigma}_2 = \hat{\sigma}_1 \sigma_2 / \sigma_1$ 
    ...
    \]
    где RMSE соответствует большому шуму.
    
    \begin{figure}[!h]
        \centering
        \includegraphics[width=\textwidth]{approx_sep_errors}
        \caption{Сравнение значений RMSE в случае большого шума и $\sqrt{B^2 + \hat{\sigma}_2^2}$ для 
            каждых методов при каждой длине окна $L$}
