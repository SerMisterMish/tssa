...
%Пусть сигнал задан в виде суммы синусоид (или комплексных экспонент в комплексном случае).
%Свойства оценок частот и оценок сигнала сильно различаются. В частности, дисперсия  оценки сигнала имеет порядок $1/N$, в то время как дисперсия оценок частот имеет порядок $1/N^3$, где $N$ --- длина временного ряда и шум белый, гауссовский.
