...
\begin{frame}{Single-Channel Series Comparison}
  ...
  \medskip
  \bluetext{RMSE statistics across all method parameters:}
  \begin{itemize}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}{c|cccc}
      ...
      \textbf{\bluetext{0.0033}} & 0.0016 &
      \textbf{\bluetext{0.0016}} \\
      \textbf{ESPRIT} & 0.0013 & 0.0140 & 0.0016 & 0.0031 \\
      \hline
    \end{tabular}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}{c|cccc}
      ...
      0.020 & \textbf{\bluetext{0.020}} \\
      \textbf{SSA} & \textbf{\bluetext{0.018}} & 0.031 & 0.020 & 0.021 \\
      \hline
    \end{tabular}
    % \caption{RMSE statistics across all method parameters}
  \end{table}
...
\begin{frame}{Multi-Channel Series Comparison}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}{c|cccc}
      ...
      5.58e-04 & \textbf{\bluetext{6.16e-04}} \\
      \textbf{M-ESPRIT} & 5.36e-04 & 1.80e-03 & 5.58e-04 & 7.13e-04 \\
      \hline
    \end{tabular}
  \end{table}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}{c|cccc}
      ...
      \textbf{\bluetext{0.068}} & \textbf{\bluetext{0.066}} &
      \textbf{\bluetext{0.066}} \\
      \textbf{MSSA} & 0.066 & 0.152 & 0.077 & 0.086 \\
      \hline
    \end{tabular}
  \end{table}
\end{frame}
...
\begin{frame}{Dtack Modifications}
  ...
  \bluetext{Undersampling}: $\displaystyle\omega \mapsto \hat\omega=
  D \omega \implies
  \max|\omega| \leqslant \frac{1}{2D}$
\end{frame}
...
\begin{frame}{Single-Channel Series Comparison with Dstack}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}{c|cccc}
      ...
      \textbf{\bluetext{5.66e-05}} & \textbf{\bluetext{5.28e-05}} &
      \textbf{\bluetext{5.32e-05}} \\
      \textbf{Dstack-ESPRIT} & 5.30e-05 & 7.63e-05 & 6.21e-05 & 6.24e-05 \\
      \textbf{T-Dstack-ESPRIT} & 5.40e-05 & 6.24e-05 & 5.88e-05 & 5.86e-05 \\
      \hline
    \end{tabular}
  \end{table}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}{c|cccc}
      ...
      & Min & Max & Median & Mean \\
      \hline
      \textbf{ESPRIT} & 0.101 & 0.138 & 0.113 & 0.115 \\
      \textbf{Dstack-ESPRIT} & 0.009 & 0.011 & 0.010 & 0.010 \\
      \textbf{T-Dstack-ESPRIT} & \textbf{\bluetext{0.003}} &
      \textbf{\bluetext{0.005}} & \textbf{\bluetext{0.004}} &
...
\begin{frame}{Single-Channel Series Comparison with Dstack}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}{c|cccc}
      ...
      \textbf{\bluetext{0.021}} & \textbf{\bluetext{0.020}} &
      \textbf{\bluetext{0.021}} \\
      \textbf{Dstack-SSA} & 0.052 & 0.066 & 0.057 & 0.057 \\
      \textbf{T-Dstack-SSA} & 0.050 & 0.052 & 0.051 & 0.051 \\
      \hline
    \end{tabular}
  \end{table}
  ...
  \begin{table}[ht]
    ...
    \begin{tabular}{c|cccc}
      ...
      \textbf{\bluetext{0.095}} & \textbf{\bluetext{0.089}} &
      \textbf{\bluetext{0.090}} \\
      \textbf{Dstack-SSA} & 0.175 & 0.208 & 0.186 & 0.189 \\
      \textbf{T-Dstack-SSA} & 0.175 & 0.179 & 0.178 & 0.178 \\
      \hline
    \end{tabular}
  \end{table}
\end{frame}
...
\begin{frame}{Results and Fututre Work}
  \bluetext{Results:}
  \begin{itemize}
    \item Tensor-based methods are generally less dependent on the
      parameters choice, and has lower minimal and maximal RMSEs except for
      single-channel signal extraction case, where basic SSA has
      lower minimal RMSE
    \item Mean and median RMSE are close for both methods in the
      single-channel case but
      in the multi-channel case tensor methods have advantage
    \item Tensor methods with applying Dstack mapping can be useful
      for estimation of parameters in presence of strong noise
      % \item Majority of tensor-based methods have lower precision than their
      %   matrix-based counterparts for single-channel problems
      % \item Exception is estimation of parameters for components with
      %   close frequencies in presence of high-level noise using Dstack
      % \item For multi-channel problems tensor-based methods have
      %   generally higher precision
      %   but the difference between minimal errors is low
  \end{itemize}
  \vspace{0.3cm}

  \bluetext{Future Work:}
  \begin{itemize}
    \item Trying other tensor decompositions (CPD, T-SVD)
    \item Implementation of tensor modifications for other SSA-based methods
    \item \dots
  \end{itemize}
\end{frame}
