...
ssa_parest_err <- calc_errors_by_params(params_grid_ssa, R, pred_ssa_est, rmse, true_params, seed = 5)

pseudo_hosvd = FALSE
tssa_err <- calc_errors_by_params(params_grid_hossa, R, pred_hossa_rec, rmse_ts_nd, signal, seed = 5)
tssa_parest_err <- calc_errors_by_params(params_grid_hoesprit, R, pred_hossa_est, rmse, true_params, seed = 5)

pseudo_hosvd = TRUE
pseudo_tssa_err <- calc_errors_by_params(params_grid_hossa, R, pred_hossa_rec, rmse_ts_nd, signal, seed = 5)
pseudo_tssa_parest_err <- calc_errors_by_params(params_grid_hoesprit, R, pred_hossa_est, rmse, true_params, seed = 5)
