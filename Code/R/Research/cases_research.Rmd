...
# plot.name <- "_regular_rates"


# no freqs
# freqs.true <- c(0, 0)
# freqs_case <- "_no_freqs"
# different freqs
freqs.true <- c(0.2, 0.22)
freqs_case <- "_regular_freqs"
# close freqs
# freqs.true <- c(0.02, 0.0205)
# freqs_case <- "_close_freqs"
...
save(ssa_err, hossa_err, file = paste0("./comp_results/cases_errors/sum_of_2_complex_periodics", rates_case, freqs_case, ".RData"))
```
