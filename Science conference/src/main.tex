...
\begin{document}
    ...
    \begin{frame}{SSA для выделения сигнала}
        ...
        \begin{enumerate}
            ...
            $\tilde{x_i} = \operatorname{mean}\left\{\tilde{\bfX}_{i,j}~|~i + j - 1 = i\right\}.$
        \end{enumerate}
    ...
    \begin{frame}{Ранг ряда}
        ...
        \begin{itemize}
            ...
            \item $x_n = \exp(\alpha n),\qquad n\in\overline{1:N}, \qquad \alpha \in \bbR$
    ...
    \begin{frame}{MSSA}
        ...
        Дальнейшие шаги алгоритма аналогичны стандартному SSA.

        \vspace{0.6cm}

        \begin{itemize}
            \item В случаях, когда ряды $\tX^{(i)}$ имеют похожую структуру, спользование MSSA даёт
        ...
        \begin{table}[!ht]
            ...
            \begin{tabular}{r|r|rrrrr}
                ...
                \begin{tabular}{r}
                           ...
                           $\psi_1 = \psi_2 = 0$\\
                \end{tabular}
                } & MSSA & 1.78 & 1.34 & 1.25 & \textbf{1.2} & 1.41 \\ \cline{2-7}
                  & HOSVD MSSA & 1.35 & \textbf{1.1} & \textbf{1.1} & \textbf{1.1} & 1.35 \\ \hhline{=|=|=====}
                \multirow{2}{*}{
                \begin{tabular}{r}
                    $\omega_1 = \omega_2 = \frac 1 {12}$\\
                ...
                \end{tabular}
                  ...
                  & HOSVD MSSA & 1.41 & \textbf{1.191} & 1.199 & \textbf{1.191} & 1.41 \\ \hhline{=|=|=====}
                \multirow{2}{*}{
                \begin{tabular}{r}
